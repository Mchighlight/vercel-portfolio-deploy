...
const BasePage = props => {
  ...
  const {
    ...
    metaDescription="My name is Hung-Chih Huang and I am an experienced software engineer and freelance developer. Throughout my career, I have acquired advanced technical knowledge and the ability to explain programming topics clearly and in detail to a broad audience.",
    canonicalPath,
    children } = props;
  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" type="image/x-icon" href="/images/kanye-bear.png"/>
        <link
          rel="canonical"
